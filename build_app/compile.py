...
files = ['main.py', 'classes/mouse_clicker.py', 'classes/keyboard_clicker.py', 'prompts.py', 'classes/key.py', 'mode.py', 'colors/vtp.py', 'colors/constants.py', 'settings.py', 'styles.py']
files_directory = 'src'
